...
namespace Tanks.TankControllers
{
	...
	public class TankMovement : NetworkBehaviour
	{
		...
		private void OnCollisionEnter(Collision c)
		{
			...
			{
				IDamageObject targetHealth = c.gameObject.GetComponentInParent<IDamageObject> ();
				...
				if (isMoving && ((m_CurrentMovementMode == MovementMode.Backward && angleToEnemy < 45)
				    			|| (m_CurrentMovementMode == MovementMode.Forward && (angleToEnemy < 180 + 45 && angleToEnemy > 180 - 45)))) 
				{
