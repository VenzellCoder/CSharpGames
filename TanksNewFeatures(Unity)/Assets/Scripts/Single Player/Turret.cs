...
namespace Tanks.Hazards
{
	...
	public class Turret : MonoBehaviour
	{
		...
		protected SinglePlayer.DifficultyLevelDetails npsDifficultyDetails;

		protected virtual void Start()
		{
			// <VENZELL> уровень сложности влияет на скорострельность
			npsDifficultyDetails = GetComponent<SinglePlayer.Npc> ().npsDifficultyDetails;
			m_TurretFireTimer *= npsDifficultyDetails.fireRateModifier;
		...
		private void DoTargeting()
		{
			...
			// <VENZELL> Уровень сложности влияет на наличие предсказания позиции игрока при прицеливании
			if (npsDifficultyDetails.fireLeading) 
			{
				//Leading
