...
namespace Tanks
{
	...
	public class GameManager : NetworkBehaviour
	{
		...
		//The crash manager prefab
		[SerializeField]
		protected CrashManager m_CrashManagerPrefab;
		...
		private void Start()
		{
			...
			// <VENZELL> Инстанцинация менеджера аварий
			if (m_CrashManagerPrefab != null)
			{
				CrashManager crashManager = Instantiate<CrashManager>(m_CrashManagerPrefab);
				NetworkServer.Spawn(crashManager.gameObject);
			}
